      ...
      <div className="container  py-16 flex items-center justify-between">
        ...
        <div className="w-1/2 flex flex-col items-start ">
          ...
          <p className="text-[16px] md:text-[20px] text-[#848484] w-full">
            Take our career assessment test to uncover your strengths,
            interests, and the ideal career paths tailored for you. Quick,
            insightful, and designed to guide your next steps with confidence.
          </p>
          {PointTest.map((item) => {
            return (
